...
<div className="sb-container">
  ...
  <div className="sb-section">
    ...
    <div className="sb-section-item">
      <img
        src="about:blank" alt="A representation of typography and image assets" />
      <div>
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      <div className="sb-grid-item">
        <img
        src="about:blank" alt="A screenshot showing the autodocs tag being set, pointing a docs page being generated" />
      ...
      <div className="sb-grid-item">
        <img 
        src="about:blank" alt="A browser window showing a Storybook being published to a chromatic.com URL" />
      ...
      <div className="sb-grid-item">
        <img
        src="about:blank" alt="Windows showing the Storybook plugin in Figma" />
      ...
      <div className="sb-grid-item">
        <img src="about:blank" alt="Screenshot of tests passing and failing" />
      ...
      <div className="sb-grid-item">
        <img src="about:blank" alt="Screenshot of accessibility tests passing and failing" />
      ...
      <div className="sb-grid-item">
        <img src="about:blank" alt="Screenshot of Storybook in light and dark mode" />
...
<div className='sb-addon'>
  ...
  <div className='sb-addon-img'>
    <img src="about:blank" alt="Integrate your tools with Storybook to connect workflows." />
  </div>
</div>

<div className="sb-section sb-socials">
    <div className="sb-section-item">
      <img src="about:blank" alt="Github logo" className="sb-explore-image"/>
    ...
    <div className="sb-section-item">
      <img src="about:blank" alt="Discord logo" className="sb-explore-image"/>
      <div>
    ...
    <div className="sb-section-item">
      <img src="about:blank" alt="Youtube logo" className="sb-explore-image"/>
      <div>
    ...
    <div className="sb-section-item">
      <img src="about:blank" alt="A book" className="sb-explore-image"/>
